...
bool Monitoring::Init_Data(string nm, string dat, string fs, string fd, bool suc, string err)
{
	if (!nm.compare("") || !dat.compare("") || !fs.compare("") || !fd.compare("") || (suc == true && !err.compare(""))) 
		return false;
